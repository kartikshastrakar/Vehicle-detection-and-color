...
colors = OrderedDict({"red": (255, 0, 0),"green": (0, 255, 0),"blue": (0,0, 255),"white":(255,255,255),"black":(100,100,100),'Orange': (255, 128, 0)
,'Grey':(84,84,84),'yellow': (255,255,0),'NavyBlue': (0,0,128),'black': (0,0,0),'Silver': (192,192,192),'Dark Green' : (47,79,47),'grey':(194,194,194)
,'Maroon':(128,0,0),'green copper': (74,118,110)})
